...
const consultingServices = [
  {
    ...
    body: "We help organisations make the right Salesforce decisions before committing budget — which clouds, what roadmap, and how to measure ROI from your CRM investment. Our no-obligation Salesforce health check gives you an honest assessment of where your current org stands and what it needs.",
    ideal: ["Businesses evaluating Salesforce", "Existing Salesforce users underperforming on ROI", "Organisations planning expansion", "Companies struggling with adoption"],
  ...
  },
  {
    ...
    ideal: ["Businesses planning cloud migration", "Companies reducing cloud costs", "Enterprises evaluating multi-cloud strategy", "Startups building cloud infrastructure"],
    deliverable: "Cloud Readiness & Strategy Report"
  },
  {
    icon: <Zap className="text-[#F59E0B]" />,
    title: "Digital Transformation Consulting",
    body: "End-to-end digital transformation advisory — mapping your business processes, identifying automation opportunities, recommending the right technology stack, and building a prioritised roadmap that delivers quick wins while building toward long-term digital maturity.",
    ideal: ["Businesses starting digital transformation", "Mid-market companies modernising operations", "Enterprises consolidating legacy systems", "Leadership needing a technology strategy"],
  ...
  },
  {
    ...
    body: "We help organisations build robust IT governance frameworks — defining policies, procedures, roles, and controls aligned to ISO 27001, GDPR, HIPAA, and NIST standards. Including GRC framework design and implementation for regulated industries.",
    ideal: ["Healthcare (HIPAA compliance)", "Businesses handling EU data (GDPR compliance)", "Financial institutions", "Enterprises preparing for ISO 27001"],
...
const trainingProgrammes = [
  ...
  },
  {
    ...
    body: "Practical cloud training covering AWS, Azure, and GCP fundamentals through to advanced topics — designed for IT teams transitioning to cloud environments and developers building cloud-native applications.",
  ...
  },
  {
    ...
    body: "People are the biggest cybersecurity risk. Our programme educates your entire workforce on real threats — phishing, social engineering, password hygiene, and data handling — reducing human error risk and building a security-conscious culture.",
