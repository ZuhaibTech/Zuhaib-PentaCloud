  ...
  return (
    <section className="py-6 sm:py-12 md:py-20 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center mb-10 sm:mb-16 md:mb-24">
      ...
      >
        ...
        <p className="text-xs sm:text-base md:text-lg lg:text-xl text-[#4A6080] max-w-2xl font-inter leading-relaxed mb-6 sm:mb-8">
      ...
      >
        <div className="bg-gradient-to-br from-white to-blue-50 p-4 sm:p-6 rounded-[24px] sm:rounded-[48px] shadow-2xl border border-white aspect-[4/3] flex items-center justify-center relative group">
           ...
           >
              <p className="text-[8px] sm:text-[10px] uppercase font-bold text-slate-500 tracking-wider mb-0.5">Cert Pass Rate</p>
              <p className="text-sm sm:text-2xl font-black text-[#34C98A]">85%+</p>
              <p className="text-[7px] sm:text-[9px] text-slate-400 font-bold leading-none mt-0.5">Exam prep participants</p>
           </motion.div>
           ...
           >
              <p className="text-[8px] sm:text-[10px] uppercase font-bold text-slate-500 tracking-wider mb-0.5">Active Certifications</p>
              <p className="text-xs sm:text-xl font-black text-[#1A7FD4]">16+</p>
              <p className="text-[7px] sm:text-[9px] text-slate-400 font-bold leading-none mt-0.5">Real expertise</p>
           </motion.div>
        </div>
      </motion.div>
    </section>
