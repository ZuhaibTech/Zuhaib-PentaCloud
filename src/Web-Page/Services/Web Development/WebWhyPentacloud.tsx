...
const WebWhyPentacloud = () => {
  ...
  return (
    <section className="py-24 bg-[#F0F6FF] relative px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-start relative">
        ...
        <div className="sticky top-28 self-start">
          <motion.div
            ...
            className="relative min-h-[580px] rounded-[32px] shadow-[0_24px_60px_rgba(26,127,212,0.3)] group flex flex-col items-center justify-center"
          ...
          <AnimatePresence>
            {activeWhy === 0 && (
              ...
              >
                <div className="font-nunito font-bold text-[14px] text-[#0D1B2A]">⚡ 90+ PageSpeed</div>
            ...
            {activeWhy === 3 && (
              ...
              >
                <div className="font-nunito font-bold text-[14px] text-[#0D1B2A]">🔒 SSL + Security</div>
            ...
            {activeWhy === 1 && (
              ...
              >
                <div className="font-nunito font-bold text-[14px] text-[#0D1B2A]">🎨 Pixel Perfect</div>
