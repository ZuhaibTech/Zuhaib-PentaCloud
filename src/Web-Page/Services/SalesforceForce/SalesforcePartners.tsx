...
const SalesforcePartners = () => {
  ...
  return (
    <div className="py-24 bg-white px-6 border-t border-slate-50">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <div className="text-[11px] font-nunito font-bold text-[#1A7FD4] tracking-[3px] uppercase mb-12">OFFICIAL TECHNOLOGY PARTNERS</div>
