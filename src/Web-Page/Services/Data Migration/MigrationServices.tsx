    ...
    <section className="mb-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {migrationServices.map((service, idx) => (
          ...
          >
            <div className="w-14 h-14 rounded-2xl bg-background shadow-inner flex items-center justify-center mb-6 border border-white/50 group-hover:scale-110 transition-transform">
              {service.icon}
            </div>
            ...
            <div className="mb-6">
              <p className="text-[#0D1B2A] font-black text-[10px] uppercase tracking-widest mb-3">What's Covered:</p>
            ...
            <div className="mt-auto pt-6 border-t border-blue-50">
              <div className="flex items-center gap-3">
                ...
                <p className="text-[10px] font-bold text-[#0D1B2A]">{service.metric}</p>
              </div>
            </div>
          </motion.div>
        ))}
