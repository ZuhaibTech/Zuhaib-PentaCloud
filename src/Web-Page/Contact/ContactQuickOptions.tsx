...
const options = [
  ...
  },
  {
    icon: <Mail />,
    title: "Email Us",
    body: "Whether it's a detailed project brief, a request for proposal, or a formal inquiry, send us an email. We'll get back to you with a thorough response within 24 hours.",
    cta: "Send Email →",
